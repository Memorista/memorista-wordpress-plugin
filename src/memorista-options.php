...
<div id="memorista-settings-container">
    ...
    <?php if ($apiKey == "" || $apiKey == null) { ?>
        ...
        <?php } else { ?>
            <h2>No permission to activate plugin</h2>
            <p>Please contact the administrator of this WordPress installation to activate Memorista.</p>
        <?php } ?>
    <?php } else { ?>
        <h2>Manage</h2>
